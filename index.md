...
Якщо не задано параметрів Cloud Commander читає інформацію з `json/config.json` і використовує стандартний порт (`8000`), якщо змінних з іменами `cloud9`, `cloudfoundry` та `nodester` не існує.
