...
```js
{
    ...
    "open"              : false,     /* відкривати веб браузер, коли сервер запущений               */
